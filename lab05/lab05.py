...
def closer_city(lat, lon, city_a, city_b):
    ...
    city_list = [city_a, city_b]
    return get_name(min(city_list, key = lambda x: distance(x, city_c)))
...
def berry_finder(t):
    ...
    if label(t) == 'berry':
        ...
        for b in branches(t):
            branch_berry = branch_berry or berry_finder(b)
        return branch_berry
...
def sprout_leaves(t, leaves):
    ...
    if is_leaf(t):
        ...
        for b in branches(t):
            branch.append(sprout_leaves(b, leaves))
